...
dataType = np.float32
dataComplexType = np.complex64
if dataType != np.float32:
    dataComplexType = np.complex128
...
dh_weights_dmpb = np.random.uniform(0.001, 1, (d, m, p, b)).astype(np.complex128)
h_impb = np.random.uniform(0.001, 1, (i, m, p, b)).astype(np.complex128)
response_dpe = np.random.uniform(0.001, 1, (d, p, e)).astype(np.float64)
timeshift_dbe = np.random.uniform(0.001, 1, (d, b, e)).astype(np.complex128)
hh_weights_dmppb = np.random.uniform(0.001, 1, (d, mm, p, p, b)).astype(np.complex128) 
asd_drift_d = np.random.uniform(0.001, 0.1, (d)).astype(np.float64)
log_weights_i = np.random.uniform(0.001, 1, (i)).astype(np.float64)
log_weights_e = np.random.uniform(0.001, 1, (e)).astype(np.float64)
debug_mode = False
